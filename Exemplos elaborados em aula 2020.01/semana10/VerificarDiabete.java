...
public class VerificarDiabete {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Instances diabetes = arff.getDataSet(8); // - Índice do atributo classe.
        
        // Representa o conjunto em uma matriz de double.
        double[][] conjunto = new double[diabetes.numInstances() -1][diabetes.numAttributes()];
        for (int i = 1; i < conjunto.length; i++) {
            conjunto[i] = diabetes.instance(i).toDoubleArray();
        }

        // Definir os dados do exemplo de teste.
        double[] teste = diabetes.instance(0).toDoubleArray();
        ...
        double classe = kNN(conjunto, teste, 5);
